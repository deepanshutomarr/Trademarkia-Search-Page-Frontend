...
on26jun2020text?: React.ReactNode; 
...
return (
<div {...props} className={`${props.className} flex sm:flex-col items-center flex-1 container-xs` }>
...
<Heading as="h6" className="text-[16px] font-bold text-[#1a1a1a] sm:text-[13px]"> 
    {metaLogoText}
</Heading>
<Heading size="texts" as="p" className="text-[14px] font-normal text-[#1a1a1a]"> 
    {facebookIncText}
</Heading>
</div>
<div className="flex flex-col items-start gap-0.5 sm: gap-0.5">
<Heading size="headings" as="p" className="text-[14px] font-semibold text-[#1a1a1a]"> 
    {eightyeightMillText}
</Heading>
<Heading size="textxs" as="p" className="text-[12px] font-medium capitalize text-[#1a1a1a]"> 
    {dateText} 
</Heading>
</div>
</div> 
...
<Heading as="h6" className="text-[16px] font-bold text-[#41b65c] sm:text-[13px]"> 
    {liveRegisteredText}
</Heading>
</div>
<Heading size="textxs" as="p" className="font-['Gilroy'] text-[12px] font-medium text-[#1alala]"> 
...
<Img src="img_qrcode.svg" width={16} height={16} alt="Qr Code Image" className="h-[16px] w-[16px]" /> <Heading size="headingxs" as="p" className="ml-1 text-[12px] font-bold text-[#1a1a1a]">
{datetext1}
</Heading>
</div>
</div>
<div className="mt-2 flex w-[60%] flex-col gap-4 sm: gap-4">
<Heading size="texts" as="p" className="text-[14px] font-medium leading-[21px] text-[#1d1c1d]"> {computerServicesText}
</Heading>
<div className="flex items-center">
<div className="flex items-center gap-1">
<Img src="img_group_1000007778.svg" width={20} height={22} alt="Moon Image" className="h-[22px]" /> <Heading size="headingxs" as="p" className="text-[12px] font-bold text-[#3a3a3a]">
{classFortyFiveText}
</Heading>
</div>
<div className="flex items-center gap-1">
<Img src="img_group_1000007778.svg" width={20} height={22} alt="Class 8 Image" className="h-[22px]" /> <Heading size="headingxs" as="p" className="text-[12px] font-bold text-[#3a3a3a]">
{classEightOneText}
</Heading>
</div>
<div className="flex items-center">
...
className="h-[22px]"
<Heading size="headingxs" as="p" className="text-[12px] font-bold text-[#3a3a3a]">
{classEightText}
